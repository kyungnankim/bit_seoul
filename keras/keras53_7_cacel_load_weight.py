...
model1 = load_model('./save/cancer/cancer_DNN_model_fit.h5')
...
model2 = load_model('./model/cancer/cancer_DNN-54-0.0571.hdf5')
...
model3.load_weights('./save/cancer/cancer_DNN_model_weight.h5') 
