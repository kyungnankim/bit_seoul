...
model.add(Dense(3000000, input_dim=1)) # 한 개 입력 
model.add(Dense(500000000)) # 다음층에 5개 Jod가 생성 
model.add(Dense(30000000000))
model.add(Dense(70000000000)) 
