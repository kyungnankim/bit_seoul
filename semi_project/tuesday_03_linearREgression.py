...
x_train, x_test, y_train, y_test = train_test_split(train_target, train_data, test_size=0.3, random_state=777)
x_train, x_predict, y_train, y_predict = train_test_split(test_target, test_data, test_size=0.3, random_state=777)
...
print(mean_absolute_error(y_test, y_predict)) #1.10000000000002 #MAE

print(mean_squared_error(y_test, y_predict)) #1.614663643863061 #MSE

print(mean_squared_log_error(y_test, y_predict)) #0.02497758378506153 #MSLE

def root_mean_squared_error(y_true, y_predict): #RMSE 0.2538356576856
    return np.sqrt(mean_squared_error(y_true, y_predict)) 
print(root_mean_squared_error(y_test, y_predict)) #1

def root_mean_squared_log_error(y_true, y_predict): #RMSLE 0.3499775787579405
    return np.sqrt(mean_squared_log_error(y_true, y_predict))
print(root_mean_squared_log_error(y_test, y_predict)) #1
