...
n_jobs = -1
# pipe = Pipeline([("scaler", StandardScaler()),('nini', XGBRegressor())])
# pipe = Pipeline([("scaler", MinMaxScaler()),('nini', XGBRegressor())])
# pipe = Pipeline([("scaler", RobustScaler()),('nini', XGBRegressor())])
