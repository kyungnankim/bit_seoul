...
#2. 모델
model=Sequential()
model.add(Dense(200, activation='relu', input_shape=(d,)))
...
model.fit(x_train, y_train, epochs=128, batch_size=128, verbose=1, validation_split=0.2, callbacks=[es])
